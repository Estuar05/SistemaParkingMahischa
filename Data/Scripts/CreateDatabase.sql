/* SistemaParkingMaisha - script idempotente para SQL Server.
   Ejecutar desde SSMS. Crea la base ParqueoMaishaDB si no existe. */

IF DB_ID(N'ParqueoMaishaDB') IS NULL
BEGIN
    CREATE DATABASE ParqueoMaishaDB;
END
GO
...
-- Configuración de la aplicación guardada en la base de datos (misma en todas las instalaciones).
